...
const PropertyEditForm = ({property}) => {
    ...
    const updatePropertyHandletr = updateProperty.bind(null,property._id)
  return (
    <form action={updatePropertyHandletr} className="w-full mx-auto bg-white p-8 rounded-lg shadow-md">
                ...
                <div className="mb-4">
                  ...
                  <textarea
                    ...
                    defaultValue={property.dscription}
                  ></textarea>
                </div>
                ...
                <div className="mb-4">
                    <div className="flex gap-2 juistify-between flex-wrap">
                        {
                            property.images && property.images.map((imgUrl, index) => (
                                <Image width={200} height={200} key={index} src={imgUrl} alt={`Property Image ${index + 1}`} className="w-40 h-40 object-cover rounded-md"/>
                            ))
                        }
                    </div>
                </div>
